.PHONY: all clean lib wasm publish format checknostd check test

all:
	$(error You must specify one of the following targets: clean lib wasm publish format checknostd test)
